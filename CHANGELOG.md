...
- Redact sensitive content before queueing or injecting cross-session context.
- Hash session labels in injected context instead of exposing raw `sessionKey` values.
- Sanitize channel metadata before injection.
- Add tests for sensitive content redaction and hashed session labels.
...
[Unreleased]: https://github.com/LucianFord/session-bus/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/LucianFord/session-bus/releases/tag/v0.1.1
